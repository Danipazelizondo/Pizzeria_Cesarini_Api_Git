...
const Register = () => {
	...
	const validateField = (name, value) => {
		...
		case 'password':
			...
			error = 'debe contener al menos una minúscula, una mayúscula y un número';
			break;
	...
	const handleSubmit = async (e) => {
		...
		setSubmitError('');
		try {
			await register({ email: formData.email, password: formData.password }); // ← llamada real
			setSubmitSuccess(true);
			navigate('/Profile');
		} catch (err) {
			setSubmitError(err?.response?.data?.message || 'No se pudo crear la cuenta');
